          ...
          <Slider {...settings}>
            ...
            <div className="p-5 bg-premium-dark">
              ...
              <div className="slider-content">
                ...
                <p>
                  Easily exclude the components you don't require. Lightweight, consistent Bootstrap
                  based styles across all elements and components
                </p>
              </div>
            </div>
            <div className="p-5 bg-sunny-morning">
              ...
              <div className="slider-content">
                ...
                <p>
                  We've included a lot of components that cover almost all use cases for any type of
                  application.
                </p>
              </div>
            </div>

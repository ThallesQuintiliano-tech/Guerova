...
const tourConfig = [
    ...
    content: function DemoHelperComponent() {
      return (
        <div>
          ...
          <Text color="#e5e5e5">
            The <Tooltip data-tooltip="this helper ⬇">tourist guide</Tooltip> could be dressed in
  ...
  },
  {
    ...
    content: function DemoHelperComponent() {
      return (
        <Text>
          The <Tooltip data-tooltip="this helper ⬇">tourist guide</Tooltip> could be positioned
          where you want.
          <br />
          In this case will try to stay in the <strong>left side</strong> if there is available
          space, otherwise will <strong>auto position</strong>.
        </Text>
      );
    },
    position: 'left',

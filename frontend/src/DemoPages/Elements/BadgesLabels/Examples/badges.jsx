                        ...
                        <Row className="g-0">
                          <Col xl="4" sm="6">
                            ...
                            >
                              ...
                              <span className="badge bg-primary badge-dot badge-dot-lg badge-dot-inside">
                                {' '}
                              </span>
                              Primary
                            </Button>
                        ...
                        <Row className="g-0">
                          <Col sm="6">
                            ...
                            >
                              ...
                              <span className="badge bg-info badge-dot badge-dot-lg badge-dot-inside">
                                {' '}
                              </span>
                              Primary
                            </Button>
                          ...
                          <Col sm="6">
                            ...
                            >
                              ...
                              <span className="badge bg-alternate badge-dot badge-dot-lg badge-dot-inside">
                                {' '}
                              </span>
                              Success
                            </Button>
                          ...
                          <Col sm="6">
                            ...
                            >
                              ...
                              <span className="badge bg-warning badge-dot badge-dot-lg badge-dot-inside">
                                {' '}
                              </span>
                              Info
                            </Button>
                  ...
                  <Card className="main-card mb-3">
                    <CardBody>
                      ...
                      <Row>
                        <Col xl="4" sm="6">
                          <Button
                            className="btn-icon-vertical mb-3 btn-transition"
                            outline
                            color="primary"
                          >
                            <i className="lnr-license btn-icon-wrapper"> </i>
                            <span className="badge bg-primary badge-dot badge-dot-sm badge-dot-inside">
                              {' '}
                            </span>
                            Primary
                          </Button>
                        ...
                        <Col xl="4" sm="6">
                          ...
                          >
                            <i className="lnr-map btn-icon-wrapper"> </i>
                            <span className="badge bg-success badge-dot badge-dot-sm badge-dot-inside">
                              {' '}
                            </span>
                            Secondary
                          </Button>
                        ...
                        <Col xl="4" sm="6">
                          ...
                          >
                            <i className="lnr-lighter btn-icon-wrapper"> </i>
                            <span className="badge bg-dark badge-dot badge-dot-lg badge-dot-inside">
                              {' '}
                            </span>
                            Danger
                          </Button>
                        ...
                        <Col xl="4" sm="6">
                          ...
                          >
                            ...
                            <span className="badge bg-focus badge-dot badge-dot-sm badge-dot-inside">
                              {' '}
                            </span>
                            Focus
                          </Button>

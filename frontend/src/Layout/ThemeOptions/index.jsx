...
import {
  setBackgroundColor as setBackgroundColorAction,
  setColorScheme as setColorSchemeAction,
  setBackgroundImage as setBackgroundImageAction,
  setBackgroundImageOpacity as setBackgroundImageOpacityAction,
  ...
  setHeaderBackgroundColor as setHeaderBackgroundColorAction,
...
function ThemeOptions() {
  ...
  const enablePageTitleIcon = useSelector((s) => s.ThemeOptions.enablePageTitleIcon);
  const enablePageTitleSubheading = useSelector((s) => s.ThemeOptions.enablePageTitleSubheading);
  ...
  const toggleEnableFixedHeader = () => dispatch(setEnableFixedHeader(!enableFixedHeader));
  const toggleEnableHeaderShadow = () => dispatch(setEnableHeaderShadow(!enableHeaderShadow));
  const toggleEnableSidebarShadow = () => dispatch(setEnableSidebarShadow(!enableSidebarShadow));
  const toggleEnableFixedSidebar = () => dispatch(setEnableFixedSidebar(!enableFixedSidebar));
  const toggleEnablePageTitleIcon = () => dispatch(setEnablePageTitleIcon(!enablePageTitleIcon));
  ...
  const setBackgroundImage = (v) => dispatch(setBackgroundImageAction(v));
  const setBackgroundImageOpacity = (v) => dispatch(setBackgroundImageOpacityAction(v));
          ...
          <div className="theme-settings__options-wrapper">
            ...
            <h3 className="themeoptions-heading">
              ...
              <Button
                size="sm"
                color="focus"
                className={cx('btn-pill btn-shadow btn-wide ms-auto', {
                ...
                <ListGroupItem>
                  ...
                  <div className="theme-settings-swatches">
                    ...
                    <div
                      ...
                      onClick={() =>
                        setHeaderBackgroundColor('bg-vicious-stance header-text-light')
                      }
                    />
                    <div
                      ...
                      onClick={() =>
                        setHeaderBackgroundColor('bg-midnight-bloom header-text-light')
                      }
                    />
                    <div
